...
import '../../bin/gg_json.dart';

void main() {
  group('bin/gg_json.dart', () {
    // #########################################################################

    test('should be executable', () async {
      // Execute bin/gg_json.dart and check if it prints help
  ...
  group('run(args, log)', () {
    group('with args=[--param, value]', () {
      test('should print "value"', () async {
        // Execute bin/gg_json.dart and check if it prints "value"
